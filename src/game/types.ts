...
export enum CardId {
  ...
  AMAP = 'AMAP',
  ATELIER_REPARATION_VELO = 'ATELIER_REPARATION_VELO',
  ...
  SIEGE_EELV = 'SIEGE_EELV',
  LES_SUBSISTANCES = 'LES_SUBSISTANCES',
  LE_FOYER = 'LE_FOYER',
  PISTE_SKI_INDOOR = 'PISTE_SKI_INDOOR',
  PETIT_PAR_SERIN = 'PETIT_PAR_SERIN',
}
